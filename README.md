...
|---|---|
| Papers scanned | **647** |
| Total flags raised | **1874** (~2.9 per paper) |
| Whole-paper assessment (after self-verify) | 100 clean · 379 minor · **164 with a major flag** · 4 likely-wrong |
| Major/critical flags sent to adversarial self-verify | **412** |
